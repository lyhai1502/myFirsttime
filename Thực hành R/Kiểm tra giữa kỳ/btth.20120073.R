...
#    Noi cach khac: H0 va H1 la 2 gia thuyet doi lap nhau da chon ơ tren.
#    
#    Nguoc lai, voi cap H0 (p=0.6) va H1 (p<0.6), neu bac bo H0 (p=0.6) (ty le = 0.6 van ko thay doi thang diem)
