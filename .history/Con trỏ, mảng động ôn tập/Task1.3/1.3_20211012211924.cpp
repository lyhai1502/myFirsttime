...
thiSinh tachChuoiTuFile(char *str)
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        else
        {
            ...
            case 3:
            {
                thisinh.toan = chartoNum(line) break;
            }
            case 4:
            {
            ...
            case 10:
            {
                tsthisinh.van = thisinh.van = charToNum(line);
                break;
            }
            case 11:
            {
            ...
            case 12:
            {
                thisinh.van = thisinh.van = charToNum(line);
                break;
            }
            case 13:
            {
...
void docThongTinThiSinh(const char *tenFile)
{
    ...
    while (!ifs.eof())
    {
        str = new char[255];
        ifs.getline(str, 255);
        list.push_back(tachChuoiTuFile(str));
        delete[] str;
    }
}
...
int main()
{
    docThongTinThiSinh("docthu1.txt");
    return 0;
}
