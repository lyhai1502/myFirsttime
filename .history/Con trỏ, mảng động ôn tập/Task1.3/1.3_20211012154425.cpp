...
thiSinh ganThongTin(string *saveValue)
{
    ...
    thisinh.toan = stof(saveValue[indexArray++], &sz);
    thisinh.van = stof(saveValue[indexArray++], &sz);
    thisinh.vatLy = stof(saveValue[indexArray++], &sz);
    thisinh.hoaHoc = stof(saveValue[indexArray++], &sz);
    thisinh.sinhHoc = stof(saveValue[indexArray++], &sz);
    thisinh.lichSu = stof(saveValue[indexArray++], &sz);
    thisinh.diaLy = stof(saveValue[indexArray++], &sz);
    thisinh.giaoducCongDan = stof(saveValue[indexArray++], &sz);
    thisinh.khoaHocTuNhien = stof(saveValue[indexArray++], &sz);
    thisinh.khoaHocXaHoi = stof(saveValue[indexArray++], &sz);
    thisinh.ngoaiNgu = stof(saveValue[indexArray++], &sz);
