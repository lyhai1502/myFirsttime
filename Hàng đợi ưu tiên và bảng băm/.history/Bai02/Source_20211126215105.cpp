...
int main()
{
    string s = "CONG TY TNHH BEE VIET NAM|0108927262|So 8 - K8, Khu nha o lien ke trung tam 75, Tong cuc II, Bo Quoc Phong, thon Lai Xa, Xa Kim Chung, Huyen Hoai Duc, Thanh pho Ha Noi";
    cout << HashString(s);
    CongTy hst[m];
    readHashTable(hst, "mst1.txt");
    cout << hst[73846].diaChi;
    return 0;
}