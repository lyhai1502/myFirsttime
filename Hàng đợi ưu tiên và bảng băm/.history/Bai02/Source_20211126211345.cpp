...
{
    CongTy congTy;
    congTy.diaChi = nullptr;
    congTy.maSoThue = nullptr;
    congTy.tenCongTy = nullptr;
}
CongTy tachChuoi(string str)
{
    ...
    for (int i = 0; i < n; i++)
    {
        if (str[i] == '|')
        {
            ...
            case 1:
            {
                congTy.diaChi = str.substr(0, i);
                break;
            }
            case 2:
            {
                congTy.maSoThue = str.substr(1, i);
                break;
            }
            default:
            {
                congTy.tenCongTy = str.substr(1);
                break;
            }
            }
        }
...
int main()
{
    string s = "CONG TY1 CO PHAN KY THUAT PHONG SACH THANH TAM|0108912989|So nha LK10-TT2, khu nha o 96+ 96B Nguyen Huy Tuong, Phuong Thanh Xuan Trung, Quan Thanh Xuan, Thanh pho Ha Noi";
    cout << s.substr(0, 4);
    return 0;
}