...
void search(string tenCongTy)
{
    ...
    {
        cout << "Ten cong ty: " << hashTable[HashString(tenCongTy)].tenCongTy << endl;
        cout << "Ma so thue: " << hashTable[HashString(tenCongTy)].maSoThue << endl;
        cout << "Dia chi: " << hashTable[HashString(tenCongTy)].diaChi << endl;
    }
    else
...
int main()
{
    ...
    search("CONG TY TNHH MTV THAN TAN HOANG LONG");
    return 0;
}